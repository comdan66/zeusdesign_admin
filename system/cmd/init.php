 ...
 */
  ...
  $directories = array ('api', 'assets', 'temp', 'upload', 'application/cell/cache', 'application/cache/file', 'application/cache/config', 'application/cache/output', 'application/cache/model');
