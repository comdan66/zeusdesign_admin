...
<div class='panel'>
  <form class='form-type1 loading' action='<?php echo base_url ($uri_1, $obj->id);?>' method='post'>
    ...
    <div class='row'>
      ...
      <input type='text' name='phone' value='<?php echo isset ($posts['phone']) ? $posts['phone'] : $obj->phone;?>' placeholder='請輸入<?php echo $title;?>電話..' maxlength='200' title='輸入<?php echo $title;?>電話!' />
    </div>

    <div class='row'>
      <b><?php echo $title;?>統一編號</b>
      <input type='text' name='tax_no' value='<?php echo isset ($posts['tax_no']) ? $posts['tax_no'] : $obj->tax_no;?>' placeholder='請輸入<?php echo $title;?>統一編號..' maxlength='200' title='輸入<?php echo $title;?>統一編號!' />
    </div>

    <div class='row'>
      <b><?php echo $title;?>地址</b>
      <input type='text' name='address' value='<?php echo isset ($posts['address']) ? $posts['address'] : $obj->address;?>' placeholder='請輸入<?php echo $title;?>地址..' maxlength='200' title='輸入<?php echo $title;?>地址!' />
    </div>
