...
<?php } ?>
    ...
    <?php } ?>
      ...
      <div class='tabs_title'>
        <a href='<?php echo base_url ('my', 'schedules');?>'<?php echo $type == 'schedules' ? " class='active'" : '';?>>今日行程</a>
        <a href='<?php echo base_url ('my', 'user_logs');?>'<?php echo $type == 'user_logs' ? " class='active'" : '';?>>活躍細節</a>
      </div>
