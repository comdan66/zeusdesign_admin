<div class='panel'>
  ...
  <form class='form' method='post' action='<?php echo base_url ($uri_1, $parent->id, $uri_2);?>'>
    ...
    <div class='row n2'>
      <label>* 聯絡人名稱</label>
      <div>
        <input type='text' name='name' value='<?php echo isset ($posts['name']) ? $posts['name'] : '';?>' placeholder='請輸入聯絡人名稱..' maxlength='200' pattern='.{1,200}' required title='輸入聯絡人名稱!' autofocus />
      </div>
    </div>
