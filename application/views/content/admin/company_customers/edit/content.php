<div class='panel'>
  ...
  <form class='form' method='post' action='<?php echo base_url ($uri_1, $parent->id, $uri_2, $obj->id);?>'>
    ...
    <div class='row n2'>
      <label>聯絡人手機</label>
      <div>
        <input type='text' name='cellphone' value='<?php echo isset ($posts['cellphone']) ? $posts['cellphone'] : $obj->cellphone;?>' placeholder='請輸入手機..' maxlength='15' />
      </div>
    </div>
    ...
    <div class='row n2'>
      <label>聯絡人個性</label>
      <div>
        <input type='text' name='experience' value='<?php echo isset ($posts['experience']) ? $posts['experience'] : $obj->experience;?>' placeholder='請輸入聯絡人個性..' maxlength='200' />
      </div>
    </div>
