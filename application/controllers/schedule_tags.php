...
class Schedule_tags extends Admin_controller {
  ...
  public function __construct () {
    ...
    $this->uri_1 = 'schedule-tags';

    if (in_array ($this->uri->rsegments (2, 0), array ('edit', 'update', 'destroy')))
      if (!(($id = $this->uri->rsegments (3, 0)) && ($this->tag = ScheduleTag::find ('one', array ('conditions' => array ('id = ?', $id))))))
  ...
  public function create () {
    ...
    $create = ScheduleTag::transaction (function () use (&$tag, $posts) {
      return verifyCreateOrm ($tag = ScheduleTag::create (array_intersect_key ($posts, ScheduleTag::table ()->columns)));
    });
  ...
  public function update () {
    ...
    $tag = $this->tag;
    $update = ScheduleTag::transaction (function () use ($tag, $posts) {
      return $tag->save ();
    });
  ...
  public function destroy () {
    $tag = $this->tag;
    $delete = ScheduleTag::transaction (function () use ($tag) {
      return $tag->destroy ();
    });
