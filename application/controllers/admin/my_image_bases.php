...
class My_image_bases extends Admin_controller {
  private $uri_1 = null;
  private $obj = null;
  private $icon = null;
  ...
  public function __construct () {
    ...
    $this->uri_1 = 'admin/my-image-bases';
    $this->icon = 'icon-cs';

    if (in_array ($this->uri->rsegments (2, 0), array ('edit', 'update', 'destroy')))
      if (!(($id = $this->uri->rsegments (3, 0)) && ($this->obj = ImageBase::find ('one', array ('conditions' => array ('id = ? AND user_id = ?', $id, User::current ()->id))))))
