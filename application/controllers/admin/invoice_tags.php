...
class Invoice_tags extends Admin_controller {
  ...
  public function index ($offset = 0) {
    ...
    $objs = InvoiceTag::find ('all', array (
        'offset' => $offset,
        'limit' => $limit,
        'order' => 'id DESC',
  ...
  public function create () {
    ...
    $create = InvoiceTag::transaction (function () use (&$obj, $posts) {
      return verifyCreateOrm ($obj = InvoiceTag::create (array_intersect_key ($posts, InvoiceTag::table ()->columns)));
    });
  ...
  public function update () {
    ...
    $obj = $this->obj;
    $update = InvoiceTag::transaction (function () use ($obj, $posts) {
      return $obj->save ();
    });
