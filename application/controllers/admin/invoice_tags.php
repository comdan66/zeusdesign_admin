...
class Invoice_tags extends Admin_controller {
  ...
  public function __construct () {
    ...
    $this->uri_1 = 'admin/invoice-tags';

    if (in_array ($this->uri->rsegments (2, 0), array ('edit', 'update', 'destroy')))
      if (!(($id = $this->uri->rsegments (3, 0)) && ($this->obj = InvoiceTag::find ('one', array ('conditions' => array ('id = ?', $id))))))
  ...
  public function index ($offset = 0) {
    ...
    $objs = InvoiceTag::find ('all', array ('offset' => $offset, 'limit' => $limit, 'order' => 'id DESC', 'include' => array ('invoices'), 'conditions' => $conditions));
  ...
  public function create () {
    ...
    if (!InvoiceTag::transaction (function () use (&$obj, $posts) { return verifyCreateOrm ($obj = InvoiceTag::create (array_intersect_key ($posts, InvoiceTag::table ()->columns))); }))
  ...
  public function update () {
    ...
    if (!InvoiceTag::transaction (function () use ($obj, $posts) { return $obj->save (); }))
  ...
  public function destroy () {
    ...
    if (!InvoiceTag::transaction (function () use ($obj) { return $obj->destroy (); }))
