...
class Schedule_tags extends Admin_controller {
  ...
  public function create () {
    ...
    UserLog::create (array ('user_id' => User::current ()->id, 'icon' => 'icon-ta', 'content' => '新增一項行程分類。', 'desc' => '分類名稱為「' . $obj->name . '」，色碼：「#' . $obj->color . '」。', 'backup' => json_encode ($obj->to_array ())));
    return redirect_message (array ($this->uri_1), array (
        '_flash_info' => '新增成功！'
      ));
  }
  ...
  public function update () {
    ...
    UserLog::create (array ('user_id' => User::current ()->id, 'icon' => 'icon-ta', 'content' => '修改一項行程分類。', 'desc' => '分類名稱為「' . $obj->name . '」，色碼：「#' . $obj->color . '」。', 'backup' => json_encode ($obj->to_array ())));
    return redirect_message (array ($this->uri_1), array (
        '_flash_info' => '更新成功！'
      ));
  }
  ...
  public function destroy () {
    ...
    $delete = ScheduleTag::transaction (function () use ($obj) { return $obj->destroy (); });
    ...
    UserLog::create (array ('user_id' => User::current ()->id, 'icon' => 'icon-ta', 'content' => '刪除一項行程分類。', 'desc' => '已經備份了刪除紀錄，細節可詢問工程師。', 'backup' => $backup));
    return redirect_message (array ($this->uri_1), array (
        '_flash_info' => '刪除成功！'
      ));
  }
